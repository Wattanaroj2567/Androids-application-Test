...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    // เมื่อมีการ bind ViewHolder เข้ากับ RecyclerView ให้กำหนดค่าที่ ImageView และ 2 TextView เป็นภาพ ชื่อ และราคาสินค้า
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.txtFooter.setText("ราคา " + product.getProduct_price() + " บาท");
